 ...
 *     body. Emacs Lisp blocks are keyword-bracketed (`if … endif`, `function …
 ...
 * [ElisprsSmartEnterProcessorTest].
 */
class ElisprsSmartEnterProcessor : SmartEnterProcessor() {
    ...
    companion object {
        ...
        /**
         * Pure function: given a Emacs Lisp source line, return the edit plan that
        ...
        fun computePlan(line: String, lineStart: Int, caret: Int, text: CharSequence): Plan? {
            ...
            // A leading `"` is a comment in Emacs Lisp.
