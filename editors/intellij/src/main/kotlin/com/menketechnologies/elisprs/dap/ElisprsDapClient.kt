...
class ElisprsDapClient(
    ...
    private fun send(msg: JsonObject) {
        ...
        try {
            ...
            com.menketechnologies.elisprs.ElisprsDebugLog.log("dap", "send failed: ${e.message}")
            alive = false
        }
    }
    ...
    companion object {
        private val LOG = Logger.getInstance(ElisprsDapClient::class.java)
    }
}
