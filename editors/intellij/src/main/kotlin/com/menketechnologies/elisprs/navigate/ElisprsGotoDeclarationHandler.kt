package com.menketechnologies.elisprs.navigate
 ...
 * only for languages with PSI references. elisprs's flat parser has
 ...
 * cursor — `elisprs --lsp` does the latter; the platform doesn't bridge
 ...
 */
class ElisprsGotoDeclarationHandler : GotoDeclarationHandler {
    ...
    override fun getGotoDeclarationTargets(
        ...
        val virtualFile = FileDocumentManager.getInstance().getFile(editor.document)
            ?: return null
        if (virtualFile.fileType != ElisprsFileType) return null
        ...
        //   (b) LSP returned the decl itself as the target (`elisprs
    ...
    private fun dbg(msg: String) {
        com.menketechnologies.elisprs.ElisprsDebugLog.log("gotodef", msg)
    }
}
