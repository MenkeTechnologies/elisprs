...
fn category_of(e: &Entry) -> &'static str {
    ...
    match e.name {
        ...
        | "fceiling" | "ffloor" | "float" | "floor" | "frexp" | "fround" | "ftruncate" | "ldexp"
        | "log" | "logand" | "logb" | "logcount" | "logior" | "lognot" | "logxor" | "lsh"
        | "mod" | "random" | "round" | "sin" | "sqrt" | "string-to-number" | "tan"
        ...
        "char-to-string" | "compare-strings" | "concat" | "downcase" | "make-string"
        | "match-beginning" | "match-data" | "match-end" | "match-string" | "number-to-string"
        | "regexp-quote" | "replace-regexp-in-string" | "save-match-data" | "set-match-data"
        | "split-string" | "string" | "string-distance" | "string-empty-p" | "string-join"
        | "string-match" | "string-match-p" | "string-prefix-p" | "string-search"
        | "string-suffix-p" | "string-to-char" | "substring" | "upcase" => "Strings & Characters",
        "--pop-output-capture--" | "--push-output-capture--" | "format" | "message" | "prin1"
        | "prin1-to-string" | "princ" | "print" | "read" | "read-from-string"
